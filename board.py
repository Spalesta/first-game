...
class Board:
    def __init__(self, width, height):
        ...
        self.height = height
        self.cell_size = 30
        self.matrix = [[False] * (self.height // self.cell_size) for _ in range(self.width // self.cell_size)]
    ...
    def click(self, pos):
        x, y = pos
        self.matrix[pos[0] // self.cell_size][pos[1] // self.cell_size] = not(self.matrix[pos[0] // self.cell_size][pos[1] // self.cell_size])
